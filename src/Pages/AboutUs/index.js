...
import Pkc from "../../assets/images/PKC.jpg";
    ...
    <div className="site-section about-section  ">
      <div className="container">
        <div className="row d-flex align-items-center justify-content-between">
          <p className="aboutBio1">In nec purus eget neque accumsan finibus. Duis condimentum elit ut libero commodo iaculis. Donec augue diam, tristique et ultricies nec, consectetur quis enim. Nullam id rutrum ex. Aliquam a lectus id lacus rhoncus dapibus non ac justo. Vivamus lacinia vestibulum metus in dapibus. Vestibulum sit amet sollicitudin enim. Ut id interdum turpis. Curabitur porta auctor quam, pretium facilisis nisl. Pellentesque efficitur elit ante, vel vulputate tortor blandit nec.</p>
          <div className="aboutBio2">
            <h3>Quisque erat urna, congue et libero in<br/>
            eleifend euismod velit.</h3>
            <p>n nec purus eget neque accumsan finibus. Duis condimentum elit ut libero commodo iaculis. Donec augue diam, tristique et ultricies nec, consectetur quis enim. Nullam id rutrum ex. Aliquam a lectus id lacus rhoncus dapibus non ac justo. Vivamus lacinia vestibulum metus in dapibus. Vestibulum sit amet sollicitudin enim. Ut id interdum turpis. Curabitur porta auctor quam, pretium facilisis nisl. Pellentesque efficitur elit ante, vel vulputate tortor blandit nec.</p>
          </div>
         
          <div class="wrapper rightSideAbout w-25 ">

<div class="box box3"> <img src={founder} alt="" /></div>
</div>
          <div className="aboutDetails w-75">
            <span className="section-title mb-4">Praveen Kumar Choudhary - Ptech Founder</span>
            <h3>Duis convallis luctus pretium.<br/> Pellentesque habitant morbi</h3>
